...
/**
 * Remove uma matéria-prima do arquivo CSV
 * @param codigo: Código da matéria-prima a ser removida
 * @return SUCESSO em caso de sucesso, código de erro caso contrário
 */
 ...
 * @param novo_produto: Ponteiro para os novos dados do produto
 * @return SUCESSO em caso de sucesso, código de erro caso contrário
 */
int atualizar_produto_arquivo(int codigo, Produto* novo_produto);

/**
 * Remove um produto do arquivo CSV
...
/**
 * Remove um relacionamento produto-matéria-prima do arquivo CSV
 * @param codigo_produto: Código do produto
 * @param codigo_materia: Código da matéria-prima
 * @return SUCESSO em caso de sucesso, código de erro caso contrário
 */
